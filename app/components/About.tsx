    ...
    <section id="about" className="mx-auto flex w-full max-w-[1200px] flex-col justify-center gap-[13px] py-10 lg:py-0">
      <div className="flex w-full flex-col items-center gap-8 lg:flex-row lg:items-center lg:space-x-[120px] lg:gap-0">
        ...
        <div className="flex w-full flex-col justify-center gap-[13px] lg:w-[608px]">
          ...
          >
            2006年、佐賀県生まれ。広島市立大学 情報科学部 情報工学科在学中。<br />幼少期は、国内・海外問わずたくさん旅行をする家庭で育ちました。また、小学5年生より、ScratchとPythonをはじめ、自分でモノを作る面白さに気づいて今に至ります。現在はPythonや、Next.jsを用いてWebアプリケーションや、Discord Bot開発などを行っているほか、企業でインターン生として勤務しています。また、高校在学中には学校のInstagramアカウント運営等を行っていた経験があり、映像制作をすることも好きです。<br/>2026年からは、広島市立大学技術系サークル いちぴろ・エクスプローラで代表を務めています。
          </motion.p>
        </div>
      </div>
    </section>
